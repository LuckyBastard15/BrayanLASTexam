...
void ABrayanLastExamCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ABrayanLastExamCharacter::Move);

		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ABrayanLastExamCharacter::Look);

	}

}

void ABrayanLastExamCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ABrayanLastExamCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
